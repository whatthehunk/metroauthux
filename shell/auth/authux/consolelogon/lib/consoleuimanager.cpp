...
DWORD ConsoleUIManager::UIThreadHostThreadProc()
{
	...
	// Metro logon elements (build 7878 recreation)
	CDUIStatusIcon::Register();
	CDUILogonUsertileElement::Register();
	CDUICredProvLogoElement::Register();
	CDUITouchScrollViewer::Register();
